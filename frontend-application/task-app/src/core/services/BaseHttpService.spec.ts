...
describe('BaseHttpService', () => {
  ...
  describe('Given:a subclass making relative-path requests', () => {
  ...
  describe('Given:a server response carrying the error envelope', () => {
  ...
  describe('Given:no response reached the client', () => {
  ...
  describe('Given:the central failure logging sink', () => {
