...
describe('useThemeStore, Given:no theme stored yet and the OS prefers dark', () => {
  beforeEach(() => {
    resetEnvironment();
...
describe('useThemeStore, Given:no theme stored yet and the OS prefers light', () => {
  beforeEach(() => {
    resetEnvironment();
    mockMatchMedia(true);
  });
...
describe('useThemeStore, Given:a theme already stored from a previous visit', () => {
  beforeEach(() => {
    resetEnvironment();
...
describe('useThemeStore, Given:toggle() called', () => {
  beforeEach(() => {
    resetEnvironment();
    mockMatchMedia(false);
  });
